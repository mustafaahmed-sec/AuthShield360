...
This online build is for fictional data and controlled demonstration while mobile and email OTP are unfinished. Do not use real school credentials or records. The precise deployment and database steps will be recorded here after the Vercel project is linked.
