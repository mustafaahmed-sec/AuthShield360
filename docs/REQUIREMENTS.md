...
| Server-enforced role access | In progress | Dashboards and Teacher writes are scoped; broader matrix testing remains. SRS 1.6(vii) |
...
| Account recovery and extra security activity features | Optional | SRS 1.4, 1.6; user backlog |
...
- Public signup will create only Student accounts. Teacher and Administrator roles require an authorized administrator action.
