...
| Automated tests for approval, scope, and admin-reviewed roster changes | Optional enhancement implemented | Run with `python manage.py test school.tests --settings=config.test_settings`; tests use a temporary in-memory SQLite database |
